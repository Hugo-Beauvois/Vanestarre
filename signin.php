...
<body>
    ...
    <main class="main_form">
        <h1>Connexion</h1>
        <?php if(isset($_SESSION['session']) && $_SESSION['session'] == 'errorEmail') echo '<span class="errorFile">Adresse mail ou mot de passe incorrect</span>' . PHP_EOL; ?>
        <form  class="form" action="signup-processing.php" method="POST"><br>
        <label for="email">E-mail :</label><br>
        <input id="email" name="email" placeholder="exemple@mail.com" type="email" maxlength="50" required="" ><br>
        <label for="mdp">Mot de passe : </label><a class="connexion recuperation" href="recuperation.php"> mot de passe oublié</a><br>
        <input id="mdp" name="mdp" placeholder="********" type="password" minlength="6" maxlength="30" required="" autocomplete="new-password"><br>
        <input class="submit" name ="action" type="submit" value="se connecter">
        </form>
    </main>
</body>
</html>
